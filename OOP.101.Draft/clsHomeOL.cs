...
namespace OOP._101.Draft
{
    ...
    internal class clsHomeOL
    {
        ...
        public clsHomeOL() // parametresiz strandart bir ctor
        {
            Console.WriteLine("Ev {0} adresinde, {1} kapı numarasında bulunuyor...", StreetName, DoorNumber);
        
        }
        public clsHomeOL (int dn) // gelen parametriyi direkt property e atadım.
        {
            DoorNumber = dn; // gelen parametriyi direkt property e atadım.
            Console.WriteLine("Ev {0} adresinde, {1} kapı numarasında bulunuyor...", StreetName, DoorNumber);
